...
class CGLSkybox : public QObject, public QOpenGLExtraFunctions
{
public:
    explicit CGLSkybox(QObject* parent = nullptr);
    virtual ~CGLSkybox();
...
private:
    GLuint loadskyBoxTexture(QStringList& fileList);
